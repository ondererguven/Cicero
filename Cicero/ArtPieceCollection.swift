...
class Collection {
    ...
    init() {
        ...
        artPiece[.appartamentiReali] = [
            ...
            ArtPiece(image: #imageLiteral(resourceName: "mobili"), imageContainer: .middle, title: "Corridoio", descr: "Stanza 54", voiceOver: "Ti trovi in uno dei corridoi degli appartamenti reali. In questa sala puoi trovare alla tua destra ed alla tua sinistra la mobilia risalente all’800 che è possibile toccare. Mentre continuando il percorso raggiungerai la sala delle porcellane."),
            ArtPiece(image:#imageLiteral(resourceName: "mobili"), imageContainer: .middle, title: "Corridoio", descr: "Stanza 55", voiceOver: "Ti trovi in uno dei corridoi degli appartamenti reali. In questa sala puoi trovare alla tua destra ed alla tua sinistra la mobilia risalente all’800 che è possibile toccare. Mentre continuando il percorso raggiungerai la sala delle porcellane."),
            ArtPiece(image: #imageLiteral(resourceName: "mobili"), imageContainer: .middle, title: "Corridoio", descr: "Stanza 59", voiceOver: "Ti trovi in uno dei corridoi degli appartamenti reali. In questa sala puoi trovare alla tua destra ed alla tua sinistra la mobilia risalente all’800 che è possibile toccare. Mentre continuando il percorso raggiungerai la sala delle porcellane."),
